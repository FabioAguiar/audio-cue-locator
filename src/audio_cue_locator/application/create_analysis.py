...
class CueRequest:
    ...
    paired with the Asset identifier to resolve. Declared independently of
    `interfaces.rest_api.schemas.AnalysisCueReference` so this module never
    depends on Interfaces (`docs/architecture.md`, Principle 2)."""
